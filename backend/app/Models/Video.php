...
class Video extends Model
{
    ...
    public static function handleRelarions(Video $video, array $attributes)
    {
    ...
    public function getTumbFileUrlAttribute()
    {
        return $this->tumb_file ? $this->getFileUrl($this->tumb_file) : null;
