...
class VideoControllerTest extends TestCase
{
    ...
    private $serializeFields = [
        'id', 'title', 'description', 'year_launched', 'rating', 'duration', 'opened',
        'video_file', 'banner_file', 'trailer_file', 'tumb_file',
        'created_at', 'updated_at', 'deleted_at',
        'categories' => ['*' => [
            'id', 'name', 'description', 'is_active', 'deleted_at', 'created_at', 'updated_at'
        ]],
        'genres' => ['*' => ['id', 'name', 'is_active', 'created_at', 'updated_at', 'deleted_at']]
    ];
